 ...
 *
 * @example <input type="text" size="20" name="VehicleID" class="{isisZipCode:true,vinUS:true}" />
...
//用户名只能由字母、数字、下划线组成
jQuery.validator.addMethod("registerInfo",function(value, element, param){
	return new RegExp(/^[a-zA-Z0-9_\u4e00-\u9fa5]+$/).test(value);
},"用户名只能由字母、数字、下划线组成");
