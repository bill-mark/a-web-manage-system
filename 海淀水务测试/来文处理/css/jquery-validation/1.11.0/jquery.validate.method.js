...
(function ($) {
	$.extend($.validator.messages, {
		...
		requiredNew: $.validator.format("{0}必填信息"),
...
jQuery.validator.addMethod("vouno",function(value, element) {
...
jQuery.validator.addMethod("phone", function(value, element) {     
	var tel = /(^(\d{3,4}-?)?\d{7,9}$)|(^1[3,5,8,7]\d{9}$)/g;     
	return this.optional(element) || (tel.test(value));     
}, "格式为:固话为区号(3-4位)号码(7-9位),手机为:13,15,18,17号段");	
