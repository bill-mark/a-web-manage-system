window.onload=function(){
    function setheight() {
        ...
        sidebar2.style.height=document.documentElement.clientHeight+155+'px';
        //sidebar2.style.width=document.documentElement.clientWidth+'px';
        sidebar.style.height=document.documentElement.clientHeight+'px';
        //var h2=sidebar2.style.height;  
        // alert(parseInt(h2));      
        //sidebar.style.height=parseInt(h2)-155+'px';
    }
    setheight();   
    } 
